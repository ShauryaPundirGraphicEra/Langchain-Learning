#             ___________________
# document->  | model1  -> notes | --\         
#             |__________________|    \     __________________
#                                      \___ | model 3 (merge )| ->user 
...
prompt1 = PromptTemplate(
    template='Generate short and simple notes easy to understand and memorize from given text {text}',
    input_variables=['text'],
)

prompt2=PromptTemplate( 
        template='Generate 5 short most important mostly asked question answer from given text {text}',
        input_variables=['text'],
)
