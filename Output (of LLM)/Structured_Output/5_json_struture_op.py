# for cross language application frontend in react and backend in python
...
# error comes as some open src model does not support structured op ,bu OpenAI does